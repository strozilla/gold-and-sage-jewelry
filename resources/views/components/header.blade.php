<header class="bg-blue-900 text-white p-4" x-data="{ open: false }">
  <div class="container mx-auto flex justify-between items-center">
    ...
    <nav class="hidden md:flex items-center space-x-4">
        ...
        <x-button-link url="/jobs/create" icon="edit" bgClass="bg-red-500">Create Job</x-button-link>
    </nav>
  ...
  >
    ...
    <x-button-link url="/jobs/create" icon="edit" bgClass="bg-red-500" :block="true">Create Job</x-button-link>
  </div>
</header>
